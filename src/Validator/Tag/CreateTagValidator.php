...
class CreateTagValidator implements ValidatorInterface
{
    use ValidatorTrait;

    private const FormTypeEnum TYPE_NAME = FormTypeEnum::Tag;

    public function __construct(readonly private CommonTagValidator $tagValidator)
    {
    }

    public function validateAndMap(array $requestData): CreateTagRequest
    {
